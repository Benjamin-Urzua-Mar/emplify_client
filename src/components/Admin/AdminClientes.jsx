...
export const AdminClientes = () => {
    ...
    if (operacion == "ban") {
      ReactSwal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch(('https://emplifyapi.burzuam.dpdns.org/admin/banCliente'), { method: "POST", body: body, headers: headers })
  ...
  const handleDelete = (_id, nombre) => {
    ...
    ReactSwal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(('https://emplifyapi.burzuam.dpdns.org/admin/deleteCliente'), { method: "POST", body: body, headers: headers })
          .then(res => res.json().then(msg => {
            setActualizarCambios(1)
            switch (msg["codigo"]) {
              case 1:
  ...
  const handleEdit = (_id) => {
    ...
    fetch(('https://emplifyapi.burzuam.dpdns.org/admin/retornarCliente'), { method: "POST", body: body, headers: headers })
      .then(res => res.json().then(msg => {
        const ReactSwal = withReactContent(Swal)
        switch (msg["codigo"]) {
          case 1:
  ...
  useEffect(() => {
    fetch(('https://emplifyapi.burzuam.dpdns.org/admin/retornarClientes'))
      .then(res => res.json().then(msg => {
