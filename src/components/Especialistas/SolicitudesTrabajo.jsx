...
export const SolicitudesTrabajo = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://emplifyapi.burzuam.dpdns.org/especialistas/getSolicitudesTrabajos', { method: 'POST', body: body, headers: headers })
    ...
    const getTrabajosEnCurso = async () => {
        ...
        fetch('https://emplifyapi.burzuam.dpdns.org/especialistas/trabajosEnCurso', { method: 'POST', body: body, headers: headers })
            .then(res => res.json().then(msg => {
                const ReactSwal = withReactContent(Swal)
    ...
    const getTrabajosTerminados = async () => {
        ...
        fetch('https://emplifyapi.burzuam.dpdns.org/especialistas/trabajosTerminados', { method: 'POST', body: body, headers: headers })
            .then(res => res.json().then(msg => {
                const ReactSwal = withReactContent(Swal)
                const toastReserva = ReactSwal.mixin({
                    toast: true,
    ...
    const aceptarTrabajo = async (e, solicitud, index) => {
        ...
        await fetch('https://emplifyapi.burzuam.dpdns.org/especialistas/aceptarTrabajo', { method: 'POST', body: body, headers: headers })
            .then(res => res.json().then(msg => {
                const ReactSwal = withReactContent(Swal)
                const toastReserva = ReactSwal.mixin({
                    toast: true,
    ...
    const finalizarTrabajo = async (e, _id, index) => {
        ...
        await fetch('https://emplifyapi.burzuam.dpdns.org/especialistas/finalizarTrabajo', { method: 'POST', body: body, headers: headers })
            .then(res => res.json().then(msg => {
                const ReactSwal = withReactContent(Swal)
                const toastReserva = ReactSwal.mixin({
                    toast: true,
