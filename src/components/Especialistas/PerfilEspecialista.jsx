...
export const PerfilEspecialista = (socket) => {
    ...
    const reservar = async () => {
        ...
        await fetch('https://emplifyapi.burzuam.dpdns.org/clientes/solicitarTrabajo', { method: 'POST', body: body, headers: headers })
    ...
    const enviarMensaje = (msg) => {
        ...
        /*
        const socket = io("https://emplifyapi.burzuam.dpdns.org/", {
            auth: {
                        ...
                        <Card className="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                            <CardHeader className="justify-between">
                                <div className="flex gap-5">
                                    <Avatar color="secondary" isBordered radius="sm" className="w-20 h-20 text-large" showFallback src={`https://emplifyapi.burzuam.dpdns.org/resources/images/${especialista.perfil.foto}`} />
